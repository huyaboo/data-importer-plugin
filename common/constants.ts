...
export const PLUGIN_ID = 'dataImporterPlugin';
export const PLUGIN_NAME = 'dataImporterPlugin';
...
export const SUPPORTED_FILE_TYPES_LIST = [CSV_FILE_TYPE, JSON_FILE_TYPE, NDJSON_FILE_TYPE];
