...
export const StaticDataIngestionApp = ({
  ...
  const onClickHandler = () => {
    ...
    http.get('/api/static_data_ingestion/example').then((res) => {
      setTimestamp(res.time);
      // Use the core notifications service to display a success message.
      notifications.toasts.addSuccess(
        i18n.translate('staticDataIngestion.dataUpdated', {
              ...
              <EuiPageContent>
                ...
                <EuiPageContentBody>
                  <EuiText>
                    <p>
                      <FormattedMessage
                        id="staticDataIngestion.content"
                    ...
                    <p>
                      <FormattedMessage
                        id="staticDataIngestion.timestampText"
                    ...
                    <EuiButton type="primary" size="s" onClick={onClickHandler}>
                      <FormattedMessage
                        id="staticDataIngestion.buttonText"
